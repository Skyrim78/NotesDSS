...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_units_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 69, 4)
    ...
    "units\0loadUnits\0\0addUnits\0deleteUnits\0"
    "editUnits\0saveUnits\0makeStatus\0text\0"
};
...
void units::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->loadUnits(); break;
        case 1: _t->addUnits(); break;
        case 2: _t->deleteUnits(); break;
        case 3: _t->editUnits(); break;
        case 4: _t->saveUnits(); break;
        case 5: _t->makeStatus((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject units::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_units.data,
      qt_meta_data_units,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_units.stringdata))
